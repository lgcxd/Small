...
<div class="login_div">
    ...
    <form action="dologin.do" class="login" method="post">
        <div class="nav">
            <div class="nav login_nav">
                ...
                <div class="col-xs-6 login_usernameInput">
                    <input type="text" name="u_name" id="name" value=""
                           placeholder="&nbsp;&nbsp;用户名" onblur="javascript:ok_or_errorBylogin(this)"/>
                </div>
...
<div class="register_body">
    ...
    <form action="userregister.do" class="register" method="post">
        <div class="nav">
            <div class="nav register_nav">
                ...
                <div class="col-xs-6">
                    <input type="text" name="u_name" id="name_r" value="" placeholder="&nbsp;&nbsp;用户名/手机号"
            ...
            <div class="nav register_psdnav">
                ...
                <div class="col-xs-6">
                    <input type="password" name="u_pwd" id="psd_r" value="" placeholder="&nbsp;&nbsp;密码"
                           onBlur="javascript:ok_or_errorByRegister(this)"/>
                </div>
                <div class="col-xs-1 ok_gou">
                    √
            ...
            <div class="nav register_affirm">
                ...
                <div class="col-xs-6">
                    <input type="password" name="u_pwds" id="affirm_psd" value="" placeholder="&nbsp;&nbsp;确认密码"
                           onBlur="javascript:ok_or_errorByRegister(this)"/>
                </div>
                <div class="col-xs-1 ok_gou">
                    √
